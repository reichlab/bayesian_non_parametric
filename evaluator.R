...
source("/Users/gcgibson/Desktop/bayesian_non_parametric/sarima/sarima_naive.R")
...
max_lag_val <- 4
last_training_points <- 52*seq(14,14)
n_aheads <- c(1,5,10)
...
mse_results[idx,"nSarimaForecast"] <- sum(as.numeric(mse_results[1:(nrow(mse_results)-1),"nSarimaForecast"]))
