 ...
 */
BEGIN_TYPETREE(Block24ActionTypeList)
LEAF_NODE(1, Action22)
...
public:
   ...
   */
  typedef GET_TYPETREE(Block24ActionTypeList) action_typelist;
...
#include "bi/updater/DynamicMaxLogDensity.hpp"
  ...
  template<class T1, bi::Location L>
  void Block24::simulates(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<class T1, bi::Location L>
  void Block24::samples(bi::Random& rng, const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<class T1, bi::Location L, class V1>
  void Block24::logDensities(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<class T1, bi::Location L, class V1>
  void Block24::maxLogDensities(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s, V1 lp)
