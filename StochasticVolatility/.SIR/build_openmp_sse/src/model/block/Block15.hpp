...
#include "../action/Action11.hpp"
#include "../action/Action12.hpp"
#include "../action/Action13.hpp"
...
BEGIN_NODE(1)
BEGIN_NODE(1)
LEAF_NODE(1, Action11)
JOIN_NODE
LEAF_NODE(1, Action12)
END_NODE
JOIN_NODE
LEAF_NODE(1, Action13)
END_NODE
...
#include "bi/updater/SparseStaticUpdater.hpp"
  ...
  template<bi::Location L>
  void Block15::simulates(bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<bi::Location L>
  void Block15::samples(bi::Random& rng, bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block15::logDensities(bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block15::maxLogDensities(bi::State<ModelSIR,L>& s, V1 lp)
  ...
  
 {
  ...
  template<bi::Location L>
  void Block15::simulates(bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask)
  
 {
  ...
  template<bi::Location L>
  void Block15::samples(bi::Random& rng, bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block15::logDensities(bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask, V1 lp)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block15::maxLogDensities(bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask, V1 lp)
