 ...
 * $Date$
 */
#ifndef LIBBI_BLOCK12_HPP
#define LIBBI_BLOCK12_HPP

#include "../action/Action0.hpp"
#include "../action/Action1.hpp"
 ...
 */
BEGIN_TYPETREE(Block12ActionTypeList)
BEGIN_NODE(1)
BEGIN_NODE(1)
LEAF_NODE(1, Action0)
JOIN_NODE
...
public:
   ...
   */
  typedef GET_TYPETREE(Block12ActionTypeList) action_typelist;
...
#include "bi/updater/SparseStaticUpdater.hpp"
  ...
  template<bi::Location L>
  void Block12::simulates(bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<bi::Location L>
  void Block12::samples(bi::Random& rng, bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block12::logDensities(bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block12::maxLogDensities(bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<class T1, bi::Location L>
  void Block12::simulates(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<class T1, bi::Location L>
  void Block12::samples(bi::Random& rng, const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<class T1, bi::Location L, class V1>
  void Block12::logDensities(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<class T1, bi::Location L, class V1>
  void Block12::maxLogDensities(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<bi::Location L>
  void Block12::simulates(bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask)
  
 {
  ...
  template<bi::Location L>
  void Block12::samples(bi::Random& rng, bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block12::logDensities(bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask, V1 lp)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block12::maxLogDensities(bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask, V1 lp)
