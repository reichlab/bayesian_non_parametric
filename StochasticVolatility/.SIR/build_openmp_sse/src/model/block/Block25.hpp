 ...
 * $Date$
 */
#ifndef LIBBI_BLOCK25_HPP
#define LIBBI_BLOCK25_HPP

#include "../action/Action23.hpp"
 ...
 */
BEGIN_TYPETREE(Block25ActionTypeList)
LEAF_NODE(1, Action23)
...
public:
   ...
   */
  typedef GET_TYPETREE(Block25ActionTypeList) action_typelist;
...
#include "bi/updater/SparseStaticUpdater.hpp"
  ...
  template<bi::Location L>
  void Block25::simulates(bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<bi::Location L>
  void Block25::samples(bi::Random& rng, bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block25::logDensities(bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block25::maxLogDensities(bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<class T1, bi::Location L>
  void Block25::simulates(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<class T1, bi::Location L>
  void Block25::samples(bi::Random& rng, const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<class T1, bi::Location L, class V1>
  void Block25::logDensities(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<class T1, bi::Location L, class V1>
  void Block25::maxLogDensities(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<bi::Location L>
  void Block25::simulates(bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask)
  
 {
  ...
  template<bi::Location L>
  void Block25::samples(bi::Random& rng, bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block25::logDensities(bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask, V1 lp)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block25::maxLogDensities(bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask, V1 lp)
