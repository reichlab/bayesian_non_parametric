 ...
 * $Date$
 */
#ifndef LIBBI_BLOCK20_HPP
#define LIBBI_BLOCK20_HPP

#include "../action/Action18.hpp"
 ...
 */
BEGIN_TYPETREE(Block20ActionTypeList)
LEAF_NODE(1, Action18)
...
public:
   ...
   */
  typedef GET_TYPETREE(Block20ActionTypeList) action_typelist;
...
#include "bi/updater/SparseStaticMaxLogDensity.hpp"
  ...
  template<bi::Location L>
  void Block20::simulates(bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<bi::Location L>
  void Block20::samples(bi::Random& rng, bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block20::logDensities(bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block20::maxLogDensities(bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<class T1, bi::Location L>
  void Block20::simulates(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<class T1, bi::Location L>
  void Block20::samples(bi::Random& rng, const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<class T1, bi::Location L, class V1>
  void Block20::logDensities(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<class T1, bi::Location L, class V1>
  void Block20::maxLogDensities(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<bi::Location L>
  void Block20::simulates(bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask)
  
 {
  ...
  template<bi::Location L>
  void Block20::samples(bi::Random& rng, bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block20::logDensities(bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask, V1 lp)
  
 {
  ...
  template<bi::Location L, class V1>
  void Block20::maxLogDensities(bi::State<ModelSIR,L>& s, const bi::Mask<L>& mask, V1 lp)
