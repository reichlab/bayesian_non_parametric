 ...
 */
#ifndef LIBBI_ACTION10_HPP
#define LIBBI_ACTION10_HPP

#include "ActionCoord10.hpp"
...
public:
   ...
   * Coordinate type.
   */
  typedef ActionCoord10 coord_type;
...
template <class T1, bi::Location L, class CX, class PX, class T2>
inline void Action10::dfdt(const T1 t,
      const bi::State<ModelSIR,L>& s, const int p,
      const CX& cox, const PX& pax, T2& dfdt) {
  ...
  const BOOST_AUTO(i_gamma_, BI_REAL(1.4));
  const CX& cox_ = cox;
  dfdt = (i_gamma_*I__);
}
