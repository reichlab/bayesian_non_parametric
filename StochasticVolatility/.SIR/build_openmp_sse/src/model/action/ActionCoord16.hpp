 ...
 */
#ifndef LIBBI_ACTIONCOORD16_HPP
#define LIBBI_ACTIONCOORD16_HPP

/**
 * Action coordinate: 16.
 *
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord16(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord16& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord16 operator++(int) {
    ActionCoord16 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord16::ActionCoord16() {
  
}

inline ActionCoord16::ActionCoord16(const int ix) {
  setIndex(ix);
}

inline void ActionCoord16::inc() {
  
  
}

inline void ActionCoord16::dec() {
  
  
}

inline int ActionCoord16::index() const {
  
  return 0;
  
}

inline void ActionCoord16::setIndex(const int ix) {  
}
