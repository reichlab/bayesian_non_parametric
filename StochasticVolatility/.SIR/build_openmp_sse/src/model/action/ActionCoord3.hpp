 ...
 */
#ifndef LIBBI_ACTIONCOORD3_HPP
#define LIBBI_ACTIONCOORD3_HPP
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord3(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord3& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord3 operator++(int) {
    ActionCoord3 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord3::ActionCoord3() {
  
}

inline ActionCoord3::ActionCoord3(const int ix) {
  setIndex(ix);
}

inline void ActionCoord3::inc() {
  
  
}

inline void ActionCoord3::dec() {
  
  
}

inline int ActionCoord3::index() const {
  
  return 0;
  
}

inline void ActionCoord3::setIndex(const int ix) {  
}
