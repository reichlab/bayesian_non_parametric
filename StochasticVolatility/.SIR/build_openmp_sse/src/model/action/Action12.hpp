 ...
 */
#ifndef LIBBI_ACTION12_HPP
#define LIBBI_ACTION12_HPP

#include "ActionCoord12.hpp"
...
struct Action12 {
   ...
   * Coordinate type.
   */
  typedef ActionCoord12 coord_type;
  ...
  template <bi::Location L, class CX, class PX, class OX>
  void Action12::simulates(bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <class T1, bi::Location L, class CX, class PX, class OX>
  void Action12::simulates(const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
