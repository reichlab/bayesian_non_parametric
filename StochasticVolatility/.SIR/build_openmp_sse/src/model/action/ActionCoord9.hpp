 ...
 */
#ifndef LIBBI_ACTIONCOORD9_HPP
#define LIBBI_ACTIONCOORD9_HPP
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord9(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord9& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord9 operator++(int) {
    ActionCoord9 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord9::ActionCoord9() {
  
}

inline ActionCoord9::ActionCoord9(const int ix) {
  setIndex(ix);
}

inline void ActionCoord9::inc() {
  
  
}

inline void ActionCoord9::dec() {
  
  
}

inline int ActionCoord9::index() const {
  
  return 0;
  
}

inline void ActionCoord9::setIndex(const int ix) {  
}
