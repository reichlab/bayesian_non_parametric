 ...
 */
#ifndef LIBBI_ACTIONCOORD25_HPP
#define LIBBI_ACTIONCOORD25_HPP

/**
 * Action coordinate: 25.
 *
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord25(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord25& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord25 operator++(int) {
    ActionCoord25 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord25::ActionCoord25() {
  
}

inline ActionCoord25::ActionCoord25(const int ix) {
  setIndex(ix);
}

inline void ActionCoord25::inc() {
  
  
}

inline void ActionCoord25::dec() {
  
  
}

inline int ActionCoord25::index() const {
  
  return 0;
  
}

inline void ActionCoord25::setIndex(const int ix) {  
}
