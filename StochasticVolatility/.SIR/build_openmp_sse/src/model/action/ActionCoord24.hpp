 ...
 */
#ifndef LIBBI_ACTIONCOORD24_HPP
#define LIBBI_ACTIONCOORD24_HPP

/**
 * Action coordinate: 24.
 *
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord24(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord24& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord24 operator++(int) {
    ActionCoord24 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord24::ActionCoord24() {
  
}

inline ActionCoord24::ActionCoord24(const int ix) {
  setIndex(ix);
}

inline void ActionCoord24::inc() {
  
  
}

inline void ActionCoord24::dec() {
  
  
}

inline int ActionCoord24::index() const {
  
  return 0;
  
}

inline void ActionCoord24::setIndex(const int ix) {  
}
