 ...
 */
#ifndef LIBBI_ACTION11_HPP
#define LIBBI_ACTION11_HPP

#include "ActionCoord11.hpp"
...
struct Action11 {
   ...
   * Coordinate type.
   */
  typedef ActionCoord11 coord_type;
  ...
  template <bi::Location L, class CX, class PX, class OX>
  void Action11::simulates(bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <class T1, bi::Location L, class CX, class PX, class OX>
  void Action11::simulates(const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
