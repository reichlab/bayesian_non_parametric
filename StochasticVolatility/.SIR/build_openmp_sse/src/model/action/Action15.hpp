 ...
 */
#ifndef LIBBI_ACTION15_HPP
#define LIBBI_ACTION15_HPP

#include "ActionCoord15.hpp"
...
struct Action15 {
   ...
   * Coordinate type.
   */
  typedef ActionCoord15 coord_type;
  ...
  template <bi::Location L, class CX, class PX, class OX>
  void Action15::simulates(bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <class T1, bi::Location L, class CX, class PX, class OX>
  void Action15::simulates(const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
