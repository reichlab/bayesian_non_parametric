 ...
 */
#ifndef LIBBI_ACTIONCOORD14_HPP
#define LIBBI_ACTIONCOORD14_HPP

/**
 * Action coordinate: 14.
 *
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord14(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord14& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord14 operator++(int) {
    ActionCoord14 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord14::ActionCoord14() {
  
}

inline ActionCoord14::ActionCoord14(const int ix) {
  setIndex(ix);
}

inline void ActionCoord14::inc() {
  
  
}

inline void ActionCoord14::dec() {
  
  
}

inline int ActionCoord14::index() const {
  
  return 0;
  
}

inline void ActionCoord14::setIndex(const int ix) {  
}
