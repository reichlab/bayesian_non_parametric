 ...
 */
#ifndef LIBBI_ACTIONCOORD11_HPP
#define LIBBI_ACTIONCOORD11_HPP

/**
 * Action coordinate: 11.
 *
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord11(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord11& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord11 operator++(int) {
    ActionCoord11 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord11::ActionCoord11() {
  
}

inline ActionCoord11::ActionCoord11(const int ix) {
  setIndex(ix);
}

inline void ActionCoord11::inc() {
  
  
}

inline void ActionCoord11::dec() {
  
  
}

inline int ActionCoord11::index() const {
  
  return 0;
  
}

inline void ActionCoord11::setIndex(const int ix) {  
}
