...
#include "bi/math/constant.hpp"
  ...
  template <bi::Location L, class CX, class PX, class OX>
  void Action7::simulates(bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <class R1, bi::Location L, class CX, class PX, class OX>
  void Action7::samples(R1& rng, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <bi::Location L, class CX, class PX, class OX, class T1>
  void Action7::logDensities(bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x, T1& lp)
  
 {
  ...
  template <bi::Location L, class CX, class PX, class OX, class T1>
  void Action7::maxLogDensities(bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x, T1& lp)
