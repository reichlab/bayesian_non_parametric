 ...
 */
#ifndef LIBBI_ACTIONCOORD17_HPP
#define LIBBI_ACTIONCOORD17_HPP

/**
 * Action coordinate: 17.
 *
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord17(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord17& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord17 operator++(int) {
    ActionCoord17 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord17::ActionCoord17() {
  
}

inline ActionCoord17::ActionCoord17(const int ix) {
  setIndex(ix);
}

inline void ActionCoord17::inc() {
  
  
}

inline void ActionCoord17::dec() {
  
  
}

inline int ActionCoord17::index() const {
  
  return 0;
  
}

inline void ActionCoord17::setIndex(const int ix) {  
}
