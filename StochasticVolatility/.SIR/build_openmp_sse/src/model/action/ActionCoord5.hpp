 ...
 */
#ifndef LIBBI_ACTIONCOORD5_HPP
#define LIBBI_ACTIONCOORD5_HPP
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord5(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord5& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord5 operator++(int) {
    ActionCoord5 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord5::ActionCoord5() {
  
}

inline ActionCoord5::ActionCoord5(const int ix) {
  setIndex(ix);
}

inline void ActionCoord5::inc() {
  
  
}

inline void ActionCoord5::dec() {
  
  
}

inline int ActionCoord5::index() const {
  
  return 0;
  
}

inline void ActionCoord5::setIndex(const int ix) {  
}
