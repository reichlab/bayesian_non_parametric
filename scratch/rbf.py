...
num_centr = len(X_train)+50             # Number of "hidden neurons" that is number of centroids
...
#    print(result[0])
    ...
    for i in range(max_iterations):
      ...
      if i%100 == 1:
        ...
        sum_ = 0
        results = []
        for test_points in range(99,149):
        ...
        print (mean_squared_error(results,SS.inverse_transform(data__full[100:150])))
        print ("=------------=\n")
      else:
