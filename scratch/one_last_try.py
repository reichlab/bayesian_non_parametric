...
for i in range(100):
    #test_ = np.linspace(0,100,len(train_X))
    x_test_encoded = vae.predict([train_X,train_y], batch_size=batch_size)
    plt.scatter(train_X,x_test_encoded,alpha=.01,color='y')
plt.show()
