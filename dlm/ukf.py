...
target = [ 1,4,2,6,3,4,10,12,21,26,21,30,45,56,75,83,82,126,119,
137,131,112,82,73,43,55,55,53,46,43,29,22,26,13,17,8,13,10,
17,19,9,9,9,3,7,7,0,2,3,3,1,3,3]
...
y_train = data[n_ahead+3:780+n_ahead]
...
myList = ','.join(map(str, clf.predict(X_test)))
print (myList) 
