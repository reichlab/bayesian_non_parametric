...
train_and_predict_dssm <- function(sanJuanDengueData,n_ahead,last_training_point){
    ...
    for (season_iter in seq(1,52)){
      cases <-sanJuanDengueData[1:(last_training_point-n_ahead+season_iter)]
      t_max = length(cases)
    ...
    return (full_season_ahead_predictions)
}