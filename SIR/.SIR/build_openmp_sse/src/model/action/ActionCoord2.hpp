 ...
 */
#ifndef LIBBI_ACTIONCOORD2_HPP
#define LIBBI_ACTIONCOORD2_HPP
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord2(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord2& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord2 operator++(int) {
    ActionCoord2 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord2::ActionCoord2() {
  
}

inline ActionCoord2::ActionCoord2(const int ix) {
  setIndex(ix);
}

inline void ActionCoord2::inc() {
  
  
}

inline void ActionCoord2::dec() {
  
  
}

inline int ActionCoord2::index() const {
  
  return 0;
  
}

inline void ActionCoord2::setIndex(const int ix) {  
}
