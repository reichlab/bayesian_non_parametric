 ...
 */
#ifndef LIBBI_ACTION4_HPP
#define LIBBI_ACTION4_HPP

#include "ActionCoord4.hpp"
...
struct Action4 {
   ...
   * Coordinate type.
   */
  typedef ActionCoord4 coord_type;
  ...
  template <bi::Location L, class CX, class PX, class OX>
  void Action4::simulates(bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <class T1, bi::Location L, class CX, class PX, class OX>
  void Action4::simulates(const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
