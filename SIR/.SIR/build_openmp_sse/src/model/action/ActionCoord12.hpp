 ...
 */
#ifndef LIBBI_ACTIONCOORD12_HPP
#define LIBBI_ACTIONCOORD12_HPP

/**
 * Action coordinate: 12.
 *
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord12(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord12& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord12 operator++(int) {
    ActionCoord12 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord12::ActionCoord12() {
  
}

inline ActionCoord12::ActionCoord12(const int ix) {
  setIndex(ix);
}

inline void ActionCoord12::inc() {
  
  
}

inline void ActionCoord12::dec() {
  
  
}

inline int ActionCoord12::index() const {
  
  return 0;
  
}

inline void ActionCoord12::setIndex(const int ix) {  
}
