 ...
 */
#ifndef LIBBI_ACTIONCOORD10_HPP
#define LIBBI_ACTIONCOORD10_HPP

/**
 * Action coordinate: 10.
 *
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord10(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord10& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord10 operator++(int) {
    ActionCoord10 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord10::ActionCoord10() {
  
}

inline ActionCoord10::ActionCoord10(const int ix) {
  setIndex(ix);
}

inline void ActionCoord10::inc() {
  
  
}

inline void ActionCoord10::dec() {
  
  
}

inline int ActionCoord10::index() const {
  
  return 0;
  
}

inline void ActionCoord10::setIndex(const int ix) {  
}
