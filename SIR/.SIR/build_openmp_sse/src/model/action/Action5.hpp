 ...
 */
#ifndef LIBBI_ACTION5_HPP
#define LIBBI_ACTION5_HPP

#include "ActionCoord5.hpp"
...
struct Action5 {
   ...
   * Coordinate type.
   */
  typedef ActionCoord5 coord_type;
  ...
  template <bi::Location L, class CX, class PX, class OX>
  void Action5::simulates(bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <class T1, bi::Location L, class CX, class PX, class OX>
  void Action5::simulates(const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
