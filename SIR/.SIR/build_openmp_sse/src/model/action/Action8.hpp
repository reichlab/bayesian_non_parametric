 ...
 */
#ifndef LIBBI_ACTION8_HPP
#define LIBBI_ACTION8_HPP

#include "ActionCoord8.hpp"
...
struct Action8 {
   ...
   * Coordinate type.
   */
  typedef ActionCoord8 coord_type;
  ...
  template <bi::Location L, class CX, class PX, class OX>
  void Action8::simulates(bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <class T1, bi::Location L, class CX, class PX, class OX>
  void Action8::simulates(const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
