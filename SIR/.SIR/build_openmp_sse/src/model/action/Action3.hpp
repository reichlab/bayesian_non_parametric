 ...
 */
#ifndef LIBBI_ACTION3_HPP
#define LIBBI_ACTION3_HPP

#include "ActionCoord3.hpp"
...
struct Action3 {
   ...
   * Coordinate type.
   */
  typedef ActionCoord3 coord_type;
  ...
  template <bi::Location L, class CX, class PX, class OX>
  void Action3::simulates(bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <class T1, bi::Location L, class CX, class PX, class OX>
  void Action3::simulates(const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
