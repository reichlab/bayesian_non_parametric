 ...
 */
#ifndef LIBBI_ACTIONCOORD15_HPP
#define LIBBI_ACTIONCOORD15_HPP

/**
 * Action coordinate: 15.
 *
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord15(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord15& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord15 operator++(int) {
    ActionCoord15 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord15::ActionCoord15() {
  
}

inline ActionCoord15::ActionCoord15(const int ix) {
  setIndex(ix);
}

inline void ActionCoord15::inc() {
  
  
}

inline void ActionCoord15::dec() {
  
  
}

inline int ActionCoord15::index() const {
  
  return 0;
  
}

inline void ActionCoord15::setIndex(const int ix) {  
}
