 ...
 */
#ifndef LIBBI_ACTIONCOORD22_HPP
#define LIBBI_ACTIONCOORD22_HPP

/**
 * Action coordinate: 22.
 *
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord22(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord22& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord22 operator++(int) {
    ActionCoord22 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord22::ActionCoord22() {
  
}

inline ActionCoord22::ActionCoord22(const int ix) {
  setIndex(ix);
}

inline void ActionCoord22::inc() {
  
  
}

inline void ActionCoord22::dec() {
  
  
}

inline int ActionCoord22::index() const {
  
  return 0;
  
}

inline void ActionCoord22::setIndex(const int ix) {  
}
