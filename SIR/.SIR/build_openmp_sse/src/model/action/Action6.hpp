...
#include "bi/math/constant.hpp"
  ...
  template <class T1, bi::Location L, class CX, class PX, class OX>
  void Action6::simulates(const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <class R1, class T1, bi::Location L, class CX, class PX, class OX>
  void Action6::samples(R1& rng, const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <class T1, bi::Location L, class CX, class PX, class OX, class T2>
  void Action6::logDensities(const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x, T2& lp)
  
 {
  ...
  template <class T1, bi::Location L, class CX, class PX, class OX, class T2>
  void Action6::maxLogDensities(const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x, T2& lp)
