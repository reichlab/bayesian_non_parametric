 ...
 */
#ifndef LIBBI_ACTIONCOORD21_HPP
#define LIBBI_ACTIONCOORD21_HPP

/**
 * Action coordinate: 21.
 *
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord21(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord21& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord21 operator++(int) {
    ActionCoord21 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord21::ActionCoord21() {
  
}

inline ActionCoord21::ActionCoord21(const int ix) {
  setIndex(ix);
}

inline void ActionCoord21::inc() {
  
  
}

inline void ActionCoord21::dec() {
  
  
}

inline int ActionCoord21::index() const {
  
  return 0;
  
}

inline void ActionCoord21::setIndex(const int ix) {  
}
