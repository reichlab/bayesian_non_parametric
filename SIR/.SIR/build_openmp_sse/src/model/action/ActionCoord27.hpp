 ...
 */
#ifndef LIBBI_ACTIONCOORD27_HPP
#define LIBBI_ACTIONCOORD27_HPP

/**
 * Action coordinate: 27.
 *
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord27(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord27& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord27 operator++(int) {
    ActionCoord27 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord27::ActionCoord27() {
  
}

inline ActionCoord27::ActionCoord27(const int ix) {
  setIndex(ix);
}

inline void ActionCoord27::inc() {
  
  
}

inline void ActionCoord27::dec() {
  
  
}

inline int ActionCoord27::index() const {
  
  return 0;
  
}

inline void ActionCoord27::setIndex(const int ix) {  
}
