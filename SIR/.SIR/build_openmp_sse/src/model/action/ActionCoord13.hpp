 ...
 */
#ifndef LIBBI_ACTIONCOORD13_HPP
#define LIBBI_ACTIONCOORD13_HPP

/**
 * Action coordinate: 13.
 *
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord13(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord13& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord13 operator++(int) {
    ActionCoord13 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord13::ActionCoord13() {
  
}

inline ActionCoord13::ActionCoord13(const int ix) {
  setIndex(ix);
}

inline void ActionCoord13::inc() {
  
  
}

inline void ActionCoord13::dec() {
  
  
}

inline int ActionCoord13::index() const {
  
  return 0;
  
}

inline void ActionCoord13::setIndex(const int ix) {  
}
