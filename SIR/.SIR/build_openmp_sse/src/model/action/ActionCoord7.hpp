 ...
 */
#ifndef LIBBI_ACTIONCOORD7_HPP
#define LIBBI_ACTIONCOORD7_HPP
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord7(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord7& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord7 operator++(int) {
    ActionCoord7 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord7::ActionCoord7() {
  
}

inline ActionCoord7::ActionCoord7(const int ix) {
  setIndex(ix);
}

inline void ActionCoord7::inc() {
  
  
}

inline void ActionCoord7::dec() {
  
  
}

inline int ActionCoord7::index() const {
  
  return 0;
  
}

inline void ActionCoord7::setIndex(const int ix) {  
}
