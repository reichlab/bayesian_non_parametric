 ...
 */
#ifndef LIBBI_ACTION7_HPP
#define LIBBI_ACTION7_HPP

#include "ActionCoord7.hpp"
...
public:
   ...
   * Coordinate type.
   */
  typedef ActionCoord7 coord_type;
...
#include "bi/math/constant.hpp"
  ...
  template <class T1, bi::Location L, class CX, class PX, class OX>
  void Action7::simulates(const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <class R1, class T1, bi::Location L, class CX, class PX, class OX>
  void Action7::samples(R1& rng, const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <class T1, bi::Location L, class CX, class PX, class OX, class T2>
  void Action7::logDensities(const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x, T2& lp)
  
 {
  ...
  template <class T1, bi::Location L, class CX, class PX, class OX, class T2>
  void Action7::maxLogDensities(const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x, T2& lp)
