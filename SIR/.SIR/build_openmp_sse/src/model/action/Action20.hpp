 ...
 */
#ifndef LIBBI_ACTION20_HPP
#define LIBBI_ACTION20_HPP

#include "ActionCoord20.hpp"
...
public:
   ...
   * Coordinate type.
   */
  typedef ActionCoord20 coord_type;
  ...
  template <bi::Location L, class CX, class PX, class OX>
  void Action20::simulates(bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <class R1, bi::Location L, class CX, class PX, class OX>
  void Action20::samples(R1& rng, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <bi::Location L, class CX, class PX, class OX, class T1>
  void Action20::logDensities(bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x, T1& lp)
  
 {
  ...
  template <bi::Location L, class CX, class PX, class OX, class T1>
  void Action20::maxLogDensities(bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x, T1& lp)
