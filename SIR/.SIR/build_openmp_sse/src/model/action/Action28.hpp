 ...
 */
#ifndef LIBBI_ACTION28_HPP
#define LIBBI_ACTION28_HPP

#include "ActionCoord28.hpp"
...
struct Action28 {
   ...
   * Target type.
   */
  typedef Var12 target_type;

  /**
   * Coordinate type.
   */
  typedef ActionCoord28 coord_type;
  ...
  template <bi::Location L, class CX, class PX, class OX>
  void Action28::simulates(bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
  
 {
  ...
  template <class T1, bi::Location L, class CX, class PX, class OX>
  void Action28::simulates(const T1 t1, const T1 t2, bi::State<ModelSIR,L>& s, const int p, const int ix, const CX& cox, const PX& pax, OX& x)
