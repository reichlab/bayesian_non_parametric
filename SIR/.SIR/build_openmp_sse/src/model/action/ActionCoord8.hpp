 ...
 */
#ifndef LIBBI_ACTIONCOORD8_HPP
#define LIBBI_ACTIONCOORD8_HPP
...
public:
   ...
   */
  CUDA_FUNC_BOTH ActionCoord8(const int ix);
   ...
   */
  CUDA_FUNC_BOTH ActionCoord8& operator++() {
    inc();
    return *this;
  }
   ...
   */
  CUDA_FUNC_BOTH ActionCoord8 operator++(int) {
    ActionCoord8 tmp(*this);
    inc();
    return tmp;
  }
...
inline ActionCoord8::ActionCoord8() {
  
}

inline ActionCoord8::ActionCoord8(const int ix) {
  setIndex(ix);
}

inline void ActionCoord8::inc() {
  
  
}

inline void ActionCoord8::dec() {
  
  
}

inline int ActionCoord8::index() const {
  
  return 0;
  
}

inline void ActionCoord8::setIndex(const int ix) {  
}
