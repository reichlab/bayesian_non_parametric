...
#include "var/Var7.hpp"
#include "var/Var8.hpp"
#include "var/Var9.hpp"
#include "var/Var10.hpp"
#include "var/Var11.hpp"
#include "var/Var12.hpp"
...
public:
   ...
   */
  static const int NPX = 1;
  
  /**
   * Number of variables in param_aux_ net.
   */
  static const int CPX = 1;
...
template<class T1, bi::Location L>
void ModelSIR::transitionSamples(bi::Random& rng, const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s) {  Block3::samples(rng, t1, t2, onDelta, s);
...
template<class T1, bi::Location L, class V1>
void ModelSIR::transitionLogDensities(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s, V1 lp) {  Block3::logDensities(t1, t2, onDelta, s, lp);
...
template<class T1, bi::Location L, class V1>
void ModelSIR::transitionMaxLogDensities(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s, V1 lp) {  Block3::maxLogDensities(t1, t2, onDelta, s, lp);
...
void ModelSIR::lookaheadTransitionSimulates(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s) {
  Block10::simulates(t1, t2, onDelta, s);
...
template<class T1, bi::Location L>
void ModelSIR::lookaheadTransitionSamples(bi::Random& rng, const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s) {  Block10::samples(rng, t1, t2, onDelta, s);
...
template<class T1, bi::Location L, class V1>
void ModelSIR::lookaheadTransitionLogDensities(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s, V1 lp) {  Block10::logDensities(t1, t2, onDelta, s, lp);
...
template<class T1, bi::Location L, class V1>
void ModelSIR::lookaheadTransitionMaxLogDensities(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s, V1 lp) {  Block10::maxLogDensities(t1, t2, onDelta, s, lp);
...
void ModelSIR::observationMaxLogDensities(bi::State<ModelSIR,L>& s,
    const bi::Mask<L>& mask, V1 lp) {
  Block5::maxLogDensities(s, mask, lp);
...
void ModelSIR::lookaheadObservationMaxLogDensities(bi::State<ModelSIR,L>& s,
    const bi::Mask<L>& mask, V1 lp) {
  Block9::maxLogDensities(s, mask, lp);
...
void ModelSIR::bridgeMaxLogDensities(bi::State<ModelSIR,L>& s,
    const bi::Mask<L>& mask, V1 lp) {
  Block8::maxLogDensities(s, mask, lp);
