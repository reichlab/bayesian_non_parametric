 ...
 */
BEGIN_TYPETREE(Block4ActionTypeList)
BEGIN_NODE(1)
BEGIN_NODE(1)
LEAF_NODE(1, Action9)
JOIN_NODE
...
public:
   ...
   */
  typedef GET_TYPETREE(Block4ActionTypeList) action_typelist;
...
#include "bi/ode/IntegratorConstants.hpp"
  ...
  template<class T1, bi::Location L>
  void Block4::simulates(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<class T1, bi::Location L>
  void Block4::samples(bi::Random& rng, const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s)
  
 {
  ...
  template<class T1, bi::Location L, class V1>
  void Block4::logDensities(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s, V1 lp)
  
 {
  ...
  template<class T1, bi::Location L, class V1>
  void Block4::maxLogDensities(const T1 t1, const T1 t2, const bool onDelta, bi::State<ModelSIR,L>& s, V1 lp)
