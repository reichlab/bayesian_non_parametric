...
prediction_files <- Sys.glob("dengue_sj_experiments/sarima/eval_predictions_forecast_box_cox_transformation_no_differencing/*.csv")
...
write_csv(prediction_scores,
  "dengue_sj_experiments/sarima/sarima-scores-eval-predictions-forecast-box-cox-transformation-no-differencing.csv"
)
